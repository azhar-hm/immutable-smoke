...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/typescript-sandbox.ts":[function(require,module,exports) {
"use strict";

// TypeScript Playground
// write, share and learn TypeScript.
var anExampleVariable = "Hello World";
var palindromeText = "race_car!";
var sentence = "The quick brown fox jumped over zakarivony";
var sentence2 = "I'm a little teapot";
...
function isPalindrome(str) {
  ...
  var reverseStr = reverseString(smallStr);
...
function titleCase2(str) {
  var titled = str.toLowerCase().split(" ").map(function (word) {
    return word[0].toUpperCase + word.slice(1);
  });
  return titled.join(" ");
}
console.log("reverseString('" + anExampleVariable + "')\n" + reverseString(anExampleVariable));
console.log("");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/typescript-sandbox.ts"], null)
//# sourceMappingURL=/typescript-sandbox.63012c5e.js.map